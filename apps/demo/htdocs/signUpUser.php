  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="signUpUser.php" method="POST">
        ...
        <button class="btn btn-lg btn-block" onclick="location.href = 'index.php';" >Back</button>
      </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Sorry, your sign up has failed. But you can try again!
    ...
    <?php
      ...
      $result = pg_query($db, "INSERT INTO users (username, userpassword, icnum, firstname, lastname, email, phonenum) VALUES ('$_POST[username]', '$_POST[userpassword]', '$_POST[icnum]',
