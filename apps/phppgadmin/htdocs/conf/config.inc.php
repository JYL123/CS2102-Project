<?php
	...
	// Database port on server (5431 is the PostgreSQL default)
	...
	$conf['servers'][0]['pg_dump_path'] = '/Applications/mappstack-7.1.13-0/postgresql/bin/pg_dump';
	$conf['servers'][0]['pg_dumpall_path'] = '/Applications/mappstack-7.1.13-0/postgresql/bin/pg_dumpall';

	// Example for a second server (PostgreSQL for Windows)
	//$conf['servers'][1]['desc'] = 'Test Server';
	//$conf['servers'][1]['host'] = '127.0.0.1';
	//$conf['servers'][1]['port'] = 5431;
