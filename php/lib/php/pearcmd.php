...
if ('/Applications/mappstack-7.1.13-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/mappstack-7.1.13-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
