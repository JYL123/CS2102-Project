...
Bitnami MAPP stack is an easy to install and easy to use open source Web
...
painless way to deploy MAPP in any OS X environment.

You can learn more about Bitnami stacks at https://bitnami.com/stacks/

Bitnami MAPP is also available as a Virtual Machine Image or as a Cloud Image.
...
Bitnami MAPP stack ships with the following software versions:
...
http://docs.bitnami.com/?page=infrastructure&name=mapp


4. REQUIREMENTS

To install Bitnami MAPP stack you will need:
...
The Bitnami MAPP stack is distributed as a binary executable installer.
...
bitnami-mappstack-7.1.13-0-osx-x86-installer.dmg

You can install Bitnami MAPP stack in graphical, text and unattended modes.
...
a regular user, or /opt/mappstack-7.1.13-0, if you are running the
...
The rest of this guide assumes that you installed Bitnami MAPP stack in
/Applications/mappstack-7.1.13-0 and that you use port 8080 for Apache and 5432 for PostgreSQL.

6. STARTING AND STOPPING BITNAMI MAPP STACK
...
installation directory:
   ...
   use_mappstack: Script to load the stack environment
   ...
   licenses/: Licenses of the components included in MAPP stack.
...
Bitnami MAPP stack. Take a look at the docs/README.txt file to know
...
PostgreSQL is distributed under the PostgreSQL License, which is located at
