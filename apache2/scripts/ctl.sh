...
HTTPD_PIDFILE=/Applications/mappstack-7.1.13-0/apache2/logs/httpd.pid


HTTPD="/Applications/mappstack-7.1.13-0/apache2/bin/httpd -f /Applications/mappstack-7.1.13-0/apache2/conf/httpd.conf"
...
. /Applications/mappstack-7.1.13-0/apache2/bin/envvars
